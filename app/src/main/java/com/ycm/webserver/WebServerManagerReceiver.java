...
public class WebServerManagerReceiver extends BroadcastReceiver {
    ...
    public WebServerManagerReceiver(WebServerActivity activity) {
        this.mActivity = activity;
        mService = new Intent(activity, WebServerService.class);
    }
