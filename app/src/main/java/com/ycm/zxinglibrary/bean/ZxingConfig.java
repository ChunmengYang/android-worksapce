package com.ycm.zxinglibrary.bean;
...
public class ZxingConfig implements Serializable {
    ...
    /*四个角的颜色*/
    @ColorRes
    private int reactColor = R.color.qrcode_react;
    /*扫描框颜色*/
    @ColorRes
    ...
    /*扫描线颜色*/
    @ColorRes
    private int scanLineColor = R.color.qrcode_scanLineColor;

    /*遮罩颜色*/
    @ColorRes
    private int maskViewColor = R.color.qrcode_viewfinder_mask;
