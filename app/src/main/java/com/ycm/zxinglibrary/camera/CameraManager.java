...
package com.ycm.zxinglibrary.camera;
...
import com.ycm.zxinglibrary.android.CaptureActivityHandler;
    ...
    public synchronized void openDriver(SurfaceHolder holder)
        ...
        if (theCamera == null) {
            ...
            if (requestedCameraId >= 0) {
                theCamera = com.ycm.zxinglibrary.camera.OpenCameraInterface.open(requestedCameraId);
            } else {
                theCamera = com.ycm.zxinglibrary.camera.OpenCameraInterface.open();
            }
